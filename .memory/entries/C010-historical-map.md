...
- 2026-05-16 Updated 3 pins + added 1. (1) Speyside village: description updated to feature the Speyside Waterwheel (near the old Speyside Estate, imported from Scotland 1834) + image added (`/i-am-tobago/images/speyside-waterwheel.jpg`). ⚠️ Arnos Vale Waterwheel (id: `arnos-vale-waterwheel`) is a SEPARATE pin — do not confuse with the Speyside waterwheel. (2) The Sisters: description updated to five-sea-stacks framing; removed "also known as St. Giles Islands" language. (3) St. Giles Island: new `islands` pin added (id: `st-giles-island`, x: 87.7, y: 8.3 — approximate NE tip, GPS unverified). 35 total pins.
