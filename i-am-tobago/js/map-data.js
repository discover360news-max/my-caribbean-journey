...
const MAP_LOCATIONS = [
  ...
  },
  {
    ...
    category: 'history',
    x: 43.2, y: 46.0,
    description: 'Rising above the central highlands, Signal Hill served as a military communications post during Tobago\'s colonial era. Messages were relayed by flag and fire between hilltop stations, keeping the island\'s scattered garrisons connected. The hill remains a landmark of the island\'s interior and a reminder of its strategic importance to European powers.'
  },
  {
    ...
    category: 'history',
    x: 18.3, y: 73.9,
    description: 'Tobago has long been claimed as the inspiration for Daniel Defoe\'s Robinson Crusoe (1719). A sea cave on the southwest coast is locally associated with the marooned sailor\'s legend. Whether Defoe ever visited remains disputed, but the island\'s wild beauty made it a convincing stand-in for a castaway\'s paradise.'
  },
